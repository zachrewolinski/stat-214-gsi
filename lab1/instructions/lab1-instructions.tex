...
I will be using \texttt{ruff} to assess code style. For simplicity, I will use its default setup, so no special configuration will be needed. Specifically, I will be running \texttt{ruff check . --output-format json} over your codebase, with the exact style points being a function of the number of style errors detected. You can run this command to check your style yourself, and also use \texttt{ruff check . --fix} to automatically fix many of these errors.
